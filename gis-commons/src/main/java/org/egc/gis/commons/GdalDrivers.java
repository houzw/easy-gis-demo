 ...
 */
@Getter
public enum GdalDrivers {

    BAG("BAG", "raster", "read-only", "Bathymetry Attributed Grid"),
    FITS("FITS", "raster", "read, write and update", "Flexible Image Transport System"),
    GMT("GMT", "raster", "read or write", "GMT NetCDF Grid Format"),
    HDF4("HDF4", "raster", "ros", "Hierarchical Data Format Release 4"),
    HDF4Image("HDF4Image", "raster", "read, write and update", "HDF4 Dataset"),
    HDF5("HDF5", "raster", "ros", "Hierarchical Data Format Release 5"),
    HDF5Image("HDF5Image", "raster", "read-only", "HDF5 Dataset"),
    KEA("KEA", "raster", "read, write and update", "KEA Image Format (.kea)"),
    netCDF("netCDF", "raster, vector", "rw+s", "Network Common Data Format"),
    VRT("VRT", "raster", "read, write and update, supporting virtual IO", "Virtual Raster"),
    GTiff("GTiff", "raster", "read, write and update, supporting virtual IO and subdatasets", "GeoTIFF"),
    NITF("NITF", "raster", "read, write and update, supporting virtual IO and subdatasets", "National Imagery Transmission Format"),
    RPFTOC("RPFTOC", "raster", "rovs", "Raster Product Format TOC format"),
    ECRGTOC("ECRGTOC", "raster", "rovs", "ECRG TOC format"),
    ...
    AIG("AIG", "raster", " read-only and virtual IO", "Arc/Info Binary Grid"),
    AAIGrid("AAIGrid", "raster", "rwv", "Arc/Info ASCII Grid"),
    GRASSASCIIGrid("GRASSASCIIGrid", "raster", " read-only and virtual IO", "GRASS ASCII Grid"),
    SDTS("SDTS", "raster", " read-only and virtual IO", "SDTS Raster"),
    DTED("DTED", "raster", "rwv", "DTED Elevation Raster"),
    PNG("PNG", "raster", "rwv", "Portable Network Graphics"),
    JPEG("JPEG", "raster", "rwv", "JPEG JFIF"),
    ...
    ESAT("ESAT", "raster", " read-only and virtual IO", "Envisat Image Format"),
    BSB("BSB", "raster", " read-only and virtual IO", "Maptech BSB Nautical Charts"),
    XPM("XPM", "raster", "rwv", "X11 PixMap Format"),
    ...
    PCRaster("PCRaster", "raster", "read, write and update", "PCRaster Raster File"),
    ILWIS("ILWIS", "raster", "read, write and update, supporting virtual IO", "ILWIS Raster Map"),
    SGI("SGI", "raster", "read, write and update", "SGI Image File Format 1.0"),
    SRTMHGT("SRTMHGT", "raster", "rwv", "SRTMHGT File Format"),
    Leveller("Leveller", "raster", "read, write and update", "Leveller heightfield"),
    Terragen("Terragen", "raster", "read, write and update", "Terragen heightfield"),
    ...
    ERS("ERS", "raster", "read, write and update, supporting virtual IO", "ERMapper .ers Labelled"),
    JP2OpenJPEG("JP2OpenJPEG", "raster, vector", "rwv", "JPEG-2000 driver based on OpenJPEG library"),
    ...
    RMF("RMF", "raster", "read, write and update, supporting virtual IO", "Raster Matrix Format"),
    ...
    RST("RST", "raster", "read, write and update, supporting virtual IO", "Idrisi Raster A.1"),
    ...
    R("R", "raster", "rwv", "R Object Data Store"),
    MAP("MAP", "raster", " read-only and virtual IO", "OziExplorer .MAP"),
    KMLSUPEROVERLAY("KMLSUPEROVERLAY", "raster", "rwv", "Kml Super Overlay"),
    Rasterlite("Rasterlite", "raster", "rws", "Rasterlite"),
    MBTiles("MBTiles", "raster", "read, write and update, supporting virtual IO", "MBTiles"),
    ...
    PNM("PNM", "raster", "read, write and update, supporting virtual IO", "Portable Pixmap Format (netpbm)"),
    DOQ1("DOQ1", "raster", " read-only and virtual IO", "USGS DOQ (Old Style)"),
    DOQ2("DOQ2", "raster", " read-only and virtual IO", "USGS DOQ (New Style)"),
    GenBin("GenBin", "raster", " read-only and virtual IO", "Generic Binary (.hdr Labelled)"),
    PAux("PAux", "raster", "read, write and update", "PCI .aux Labelled"),
    MFF("MFF", "raster", "read, write and update, supporting virtual IO", "Vexcel MFF Raster"),
    ...
    BT("BT", "raster", "read, write and update, supporting virtual IO", "VTP .bt (Binary Terrain) 1.3 Format"),
    ...
    GTX("GTX", "raster", "read, write and update, supporting virtual IO", "NOAA Vertical Datum .GTX"),
    LOSLAS("LOSLAS", "raster", " read-only and virtual IO", "NADCON .los/.las Datum Grid Shift"),
    ...
    ACE2("ACE2", "raster", " read-only and virtual IO", "ACE2"),
    SNODAS("SNODAS", "raster", " read-only and virtual IO", "Snow Data Assimilation System"),
    KRO("KRO", "raster", "read, write and update, supporting virtual IO", "KOLOR Raw"),
    ROI_PAC("ROI_PAC", "raster", "read, write and update, supporting virtual IO", "ROI_PAC raster"),
    ENVI("ENVI", "raster", "read, write and update, supporting virtual IO", "ENVI .hdr Labelled"),
    ...
    USGSDEM("USGSDEM", "raster", "rwv", "USGS Optional ASCII DEM (and CDED)"),
    GXF("GXF", "raster", "read-only", "GeoSoft Grid Exchange Format"),
    NWT_GRD("NWT_GRD", "raster", " read-only and virtual IO", "Northwood Numeric Grid Format .grd/.tab"),
    NWT_GRC("NWT_GRC", "raster", " read-only and virtual IO", "Northwood Classified Grid Format .grc/.tab"),
    ADRG("ADRG", "raster", "read, write and update, supporting virtual IO and subdatasets", "ARC Digitized Raster Graphics"),
    SRP("SRP", "raster", "rovs", "Standard Raster Product (ASRP/USRP)"),
    ...
    XYZ("XYZ", "raster", "rwv", "ASCII Gridded XYZ"),
    HF2("HF2", "raster", "rwv", "HF2/HFZ heightfield raster"),
    ...
    E00GRID("E00GRID", "raster", " read-only and virtual IO", "Arc/Info Export E00 GRID"),
    ZMap("ZMap", "raster", "rwv", "ZMap Plus Grid"),
    NGSGEOID("NGSGEOID", "raster", " read-only and virtual IO", "NOAA NGS Geoid Height Grids"),
    IRIS("IRIS", "raster", " read-only and virtual IO", "IRIS data (.PPI, .CAPPi etc)"),
    DB2ODBC("DB2ODBC", "raster, vector", "read, write and update", "IBM DB2 Spatial Database"),
    PCIDSK("PCIDSK", "raster, vector", "read, write and update, supporting virtual IO", "PCIDSK Database File"),
    PDF("PDF", "raster, vector", "w+", "Geospatial PDF"),
    ...
    OGR_VRT("OGR_VRT", "vector", " read-only and virtual IO", "VRT,Virtual Datasource"),
    ...
    GML("GML", "vector", "read, write and update, supporting virtual IO", "Geography Markup Language(GML)"),
    GPX("GPX", "vector", "read, write and update, supporting virtual IO", "GPX"),
    KML("KML", "vector", "read, write and update, supporting virtual IO", "Keyhole Markup Language (KML)"),
    GeoJSON("GeoJSON", "vector", "read, write and update, supporting virtual IO", "GeoJSON"),
    ...
    DXF("DXF", "vector", "read, write and update, supporting virtual IO", "AutoCAD DXF"),
    ...
    ODS("ODS", "vector", "read, write and update, supporting virtual IO", "Open Document/ LibreOffice / OpenOffice Spreadsheet"),
    ...
    AVCE00("AVCE00", "vector", "read-only", "Arc/Info E00 (ASCII) Coverage"),
    ...
    GdalDrivers(String name, String readOrWrite, String type, String description) {
        this.name = name;
        this.type = type;
